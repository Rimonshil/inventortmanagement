...
<body id="page-top">
  ...
  <div id="wrapper">
    <!-- Sidebar -->
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar" id="sidebar" style="display: none;" v-show="$route.path==='/' || $route.path==='/registerv2' ||$route.path==='/forget' ? false :true ">
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap6" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <router-link class="collapse-item" to="/all-salary">All Salary</router-link>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        <!-- TopBar -->
        <nav class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top" id="topbar" v-show="$route.path==='/' || $route.path==='/registerv2' ||$route.path==='/forget' ? false :true ">
...
<script src="{{asset('js/app.js')}}"></script>
  ...
  <script src="{{asset('backendvendor/jquery-easing/jquery.easing.min.js')}}"></script>
